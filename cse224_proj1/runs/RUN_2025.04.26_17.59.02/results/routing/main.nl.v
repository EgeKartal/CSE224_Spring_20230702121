module main (in,
 ...
 sky130_fd_sc_hd__nor2_1 _10_ (.A(net7),
    .B(net8),
    .Y(_00_));
 sky130_fd_sc_hd__xnor2_1 _11_ (.A(net6),
    .B(_00_),
    .Y(net14));
 sky130_fd_sc_hd__o31a_1 _12_ (.A1(net7),
    .A2(net8),
    .A3(net6),
    .B1(net5),
    .X(_01_));
 sky130_fd_sc_hd__or4_2 _13_ (.A(net7),
    .B(net8),
    .C(net6),
    .D(net5),
    .X(_02_));
 ...
 sky130_fd_sc_hd__nor2_1 _18_ (.A(_04_),
    .B(_05_),
    .Y(net12));
 sky130_fd_sc_hd__xnor2_1 _19_ (.A(net3),
    .B(_04_),
    .Y(net11));
 sky130_fd_sc_hd__or4_1 _20_ (.A(net4),
    ...
    .D(_02_),
    .X(_06_));
 sky130_fd_sc_hd__o31ai_1 _21_ (.A1(net4),
    .A2(net3),
    .A3(_02_),
    .B1(net2),
    .Y(_07_));
 ...
 sky130_fd_sc_hd__xor2_1 _24_ (.A(net1),
    .B(_06_),
    .X(net9));
 sky130_fd_sc_hd__and2_1 _25_ (.A(net7),
    .B(net8),
    .X(_09_));
 ...
 sky130_fd_sc_hd__buf_1 input7 (.A(in[6]),
    .X(net7));
 sky130_fd_sc_hd__dlymetal6s2s_1 input8 (.A(in[7]),
    .X(net8));
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_1_10 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_1_14 ();
 sky130_ef_sc_hd__decap_12 FILLER_0_1_22 ();
 sky130_fd_sc_hd__decap_3 FILLER_0_1_34 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_7_11 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_8_36 ();
