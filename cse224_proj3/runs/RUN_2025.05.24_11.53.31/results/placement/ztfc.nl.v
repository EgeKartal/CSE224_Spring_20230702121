module ztfc (an0,
 ...
 sky130_fd_sc_hd__a21boi_2 _249_ (.A1(_098_),
    ...
    .B1_N(_057_),
    .Y(_030_));
 sky130_fd_sc_hd__dfxtp_4 _250_ (.CLK(clk),
    .D(_000_),
    .Q(\a.count[0] ));
 sky130_fd_sc_hd__dfxtp_4 _251_ (.CLK(clk),
    .D(_001_),
    .Q(\a.count[1] ));
 sky130_fd_sc_hd__dfxtp_2 _252_ (.CLK(clk),
    .D(_002_),
    .Q(\a.count[2] ));
 sky130_fd_sc_hd__dfxtp_2 _253_ (.CLK(clk),
    .D(_003_),
    .Q(\a.count[3] ));
 sky130_fd_sc_hd__dfxtp_4 _254_ (.CLK(clk),
    .D(_004_),
    .Q(\a.one_second_counter[0] ));
 sky130_fd_sc_hd__dfxtp_4 _255_ (.CLK(clk),
    .D(_005_),
    .Q(\a.one_second_counter[1] ));
 sky130_fd_sc_hd__dfxtp_2 _256_ (.CLK(clk),
    .D(_006_),
    .Q(\a.one_second_counter[2] ));
 sky130_fd_sc_hd__dfxtp_2 _257_ (.CLK(clk),
    .D(_007_),
    .Q(\a.one_second_counter[3] ));
 sky130_fd_sc_hd__dfxtp_2 _258_ (.CLK(clk),
    .D(_008_),
    .Q(\a.one_second_counter[4] ));
 sky130_fd_sc_hd__dfxtp_2 _259_ (.CLK(clk),
    .D(_009_),
    .Q(\a.one_second_counter[5] ));
 sky130_fd_sc_hd__dfxtp_1 _260_ (.CLK(clk),
    .D(_010_),
    .Q(\a.one_second_counter[6] ));
 sky130_fd_sc_hd__dfxtp_2 _261_ (.CLK(clk),
    .D(_011_),
    .Q(\a.one_second_counter[7] ));
 sky130_fd_sc_hd__dfxtp_4 _262_ (.CLK(clk),
    .D(_012_),
    .Q(\a.one_second_counter[8] ));
 sky130_fd_sc_hd__dfxtp_2 _263_ (.CLK(clk),
    .D(_013_),
    .Q(\a.one_second_counter[9] ));
 sky130_fd_sc_hd__dfxtp_2 _264_ (.CLK(clk),
    .D(_014_),
    .Q(\a.one_second_counter[10] ));
 sky130_fd_sc_hd__dfxtp_4 _265_ (.CLK(clk),
    .D(_015_),
    .Q(\a.one_second_counter[11] ));
 sky130_fd_sc_hd__dfxtp_2 _266_ (.CLK(clk),
    .D(_016_),
    .Q(\a.one_second_counter[12] ));
 sky130_fd_sc_hd__dfxtp_2 _267_ (.CLK(clk),
    .D(_017_),
    .Q(\a.one_second_counter[13] ));
 sky130_fd_sc_hd__dfxtp_1 _268_ (.CLK(clk),
    .D(_018_),
    .Q(\a.one_second_counter[14] ));
 sky130_fd_sc_hd__dfxtp_2 _269_ (.CLK(clk),
    .D(_019_),
    .Q(\a.one_second_counter[15] ));
 sky130_fd_sc_hd__dfxtp_2 _270_ (.CLK(clk),
    .D(_020_),
    .Q(\a.one_second_counter[16] ));
 sky130_fd_sc_hd__dfxtp_2 _271_ (.CLK(clk),
    .D(_021_),
    .Q(\a.one_second_counter[17] ));
 sky130_fd_sc_hd__dfxtp_1 _272_ (.CLK(clk),
    .D(_022_),
    .Q(\a.one_second_counter[18] ));
 sky130_fd_sc_hd__dfxtp_4 _273_ (.CLK(clk),
    .D(_023_),
 ...
 sky130_fd_sc_hd__dfxtp_4 _276_ (.CLK(clk),
    .D(_026_),
    .Q(\a.one_second_counter[22] ));
 sky130_fd_sc_hd__dfxtp_2 _277_ (.CLK(clk),
    .D(_027_),
    .Q(\a.one_second_counter[23] ));
 sky130_fd_sc_hd__dfxtp_4 _278_ (.CLK(clk),
    .D(_028_),
    .Q(\a.one_second_counter[24] ));
 sky130_fd_sc_hd__dfxtp_4 _279_ (.CLK(clk),
    .D(_029_),
